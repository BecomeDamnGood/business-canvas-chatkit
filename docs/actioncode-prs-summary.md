...
| pr9 | `3815b1a` pr9: strict ActionCode handling and UI flags | 2 | +65 / -25 | mcp-server/src/handlers/run_step.ts<br>mcp-server/ui/step-card.html |
| pr8 | `d57ad00` pr8: enforce menu contract and gate legacy routing | 2 | +15 / -8 | mcp-server/src/handlers/run_step.ts<br>mcp-server/ui/step-card.html |
| pr7 | `0484a63` pr7: use registry action codes with fallback | 1 | +23 / -4 | mcp-server/ui/step-card.html |
| pr6 | `1dce26e` pr6: add shadow-compare telemetry | 2 | +70 / -1 | mcp-server/src/handlers/run_step.ts<br>mcp-server/ui/step-card.html |
...
| pr3 | `fa8dd3b` pr3: add input_mode to run_step | 2 | +6 / -0 | mcp-server/src/handlers/run_step.ts<br>mcp-server/ui/step-card.html |
