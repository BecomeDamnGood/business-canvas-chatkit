...
| Shared success/error/fail-closed response assembly helpers | `mcp-server/src/handlers/run_step.ts` | `mcp-server/src/handlers/run_step_response.ts` | Step 6 | pending |
