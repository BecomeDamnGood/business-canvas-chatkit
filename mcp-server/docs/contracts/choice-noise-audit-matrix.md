...
|---|---|---|---|
| dream | `DREAM_MENU_CONFIRM_SINGLE` | `ACTION_DREAM_REFINE_CONFIRM` | `ACTION_DREAM_REFINE_START_EXERCISE` |
| dream (explainer) | `DREAM_EXPLAINER_MENU_CONFIRM_SINGLE` | `ACTION_DREAM_EXPLAINER_REFINE_CONFIRM` | `ACTION_DREAM_EXPLAINER_REFINE_ADJUST` |
