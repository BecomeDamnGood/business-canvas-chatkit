...
|---|---|---|---|
| `dream` | `DREAM_MENU_INTRO` | `DREAM_MENU_INTRO` | `DREAM_MENU_CONFIRM_SINGLE` |
...
| `DREAM_MENU_CONFIRM_SINGLE` | `dream` | 2 | 1 | 1 | yes | `ACTION_DREAM_REFINE_CONFIRM` | `ACTION_DREAM_REFINE_START_EXERCISE` |
