...
import { z } from "zod";
export const STEP_0_ID = "step_0";
export const STEP_0_SPECIALIST = "ValidationAndBusinessName";
/**
 ...
 */
export function buildStep0SpecialistInput(userMessage, language = "") {
 ...
 */
export function parseValidationAndBusinessNameOutput(raw) {
