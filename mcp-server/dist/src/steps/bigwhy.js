 ...
 */
export function buildBigWhySpecialistInput(userMessage, introShownForStep = "", currentStep = BIGWHY_STEP_ID, language = "") {
...
- message=""
- question=""
- refined_formulation: concise Big Why (one sentence, optionally a second), meaning-layer phrasing, no first-person plural, universal, resonant with Dream and Purpose themes.
