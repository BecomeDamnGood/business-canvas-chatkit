...
import { z } from "zod";
export const TARGETGROUP_STEP_ID = "targetgroup";
export const TARGETGROUP_SPECIALIST = "TargetGroup";
/**
 ...
 */
export function buildTargetGroupSpecialistInput(userMessage, introShownForStep = "", currentStep = TARGETGROUP_STEP_ID, language = "", contextBlock = "") {
