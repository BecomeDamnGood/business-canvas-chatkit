...
import { z } from "zod";
export const DREAM_STEP_ID = "dream";
export const DREAM_STEP_LABEL = "Dream";
export const DREAM_SPECIALIST = "Dream";
/**
 ...
 */
export function buildDreamSpecialistInput(userMessage, introShownForStep = "", currentStep = DREAM_STEP_ID, language = "") {
 ...
 * Parse helper
 */
export function parseDreamOutput(raw) {
