...
import { z } from "zod";
import { STEP_0_ID, VALIDATION_AND_BUSINESS_NAME_INSTRUCTIONS, } from "../steps/step_0_validation.js";
import { DREAM_INSTRUCTIONS, } from "../steps/dream.js";
import { DREAM_EXPLAINER_INSTRUCTIONS, } from "../steps/dream_explainer.js";
import { PURPOSE_INSTRUCTIONS, } from "../steps/purpose.js";
import { BIGWHY_INSTRUCTIONS, } from "../steps/bigwhy.js";
import { ROLE_INSTRUCTIONS, } from "../steps/role.js";
import { ENTITY_INSTRUCTIONS, } from "../steps/entity.js";
import { STRATEGY_INSTRUCTIONS, } from "../steps/strategy.js";
import { RULESOFTHEGAME_INSTRUCTIONS, } from "../steps/rulesofthegame.js";
import { PRESENTATION_INSTRUCTIONS, } from "../steps/presentation.js";
/**
 * Incoming tool args
...
`;
    ...
    $;
    {
        safe(state.business_name);
    }
    -intro_shown_for_step;
    $;
    {
        safe(state.intro_shown_for_step);
    }
    -intro_shown_session;
    $;
    {
        safe(state.intro_shown_session);
    }
    -last_specialist_result_json;
    $;
    {
        safe(last);
    }
