...
export type DreamExplainerOutput = z.infer<typeof DreamExplainerZodSchema>;
 ...
 * - CURRENT_STEP: <string>
 * - LANGUAGE: <string>
 * - PREVIOUS_STATEMENTS: JSON array of strings (canonical list so far; append only)
 * - PREVIOUS_STATEMENT_COUNT: number (length of PREVIOUS_STATEMENTS; for first-time clustering: previous_count < 20 AND new_count >= 20)
 ...
 * Parse helper
 */
export function parseDreamExplainerOutput(raw: unknown): DreamExplainerOutput {
