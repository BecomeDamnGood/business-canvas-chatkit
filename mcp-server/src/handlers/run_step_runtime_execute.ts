...
export async function runStepRuntimeExecute(
  ...
  const routePorts = {
    ids: { step0Id: STEP_0_ID, step0Specialist: STEP_0_SPECIALIST, dreamStepId: DREAM_STEP_ID, dreamSpecialist: DREAM_SPECIALIST, dreamExplainerSpecialist: DREAM_EXPLAINER_SPECIALIST, roleStepId: ROLE_STEP_ID, roleSpecialist: ROLE_SPECIALIST, presentationStepId: PRESENTATION_STEP_ID, presentationSpecialist: PRESENTATION_SPECIALIST, bigwhySpecialist: BIGWHY_SPECIALIST, entitySpecialist: ENTITY_SPECIALIST },
    tokens: { dreamPickOneRouteToken: DREAM_PICK_ONE_ROUTE_TOKEN, bigWhyChooseForMeRouteToken: BIGWHY_CHOOSE_FOR_ME_ROUTE_TOKEN, roleChooseForMeRouteToken: ROLE_CHOOSE_FOR_ME_ROUTE_TOKEN, entityChooseForMeRouteToken: ENTITY_CHOOSE_FOR_ME_ROUTE_TOKEN, presentationMakeRouteToken: PRESENTATION_MAKE_ROUTE_TOKEN, switchToSelfDreamToken: SWITCH_TO_SELF_DREAM_TOKEN, dreamStartExerciseRouteToken: DREAM_START_EXERCISE_ROUTE_TOKEN },
    ...
    suggestions: { pickDreamSuggestionFromPreviousState, pickDreamCandidateFromState, pickBigWhySuggestionFromPreviousState, pickRoleSuggestionFromPreviousState, pickEntitySuggestionFromPreviousState },
    i18n: { bumpUiI18nCounter: uiI18nCounterPort },
  };
