...
export const BIGWHY_CHOOSE_FOR_ME_ROUTE_TOKEN = "__ROUTE__BIGWHY_CHOOSE_FOR_ME__";
export const ROLE_CHOOSE_FOR_ME_ROUTE_TOKEN = "__ROUTE__ROLE_CHOOSE_FOR_ME__";
export const ENTITY_CHOOSE_FOR_ME_ROUTE_TOKEN = "__ROUTE__ENTITY_CHOOSE_FOR_ME__";
