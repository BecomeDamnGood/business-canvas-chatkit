...
function createAppServer() {
  ...
  server.registerTool(
    ...
    async (args) => {
      ...
      // IMPORTANT:
      // - Widget reads structuredContent.ui from window.openai.toolOutput. :contentReference[oaicite:5]{index=5}
      ...
      return {
        ...
        _meta: {
          // Redundant but helpful if host prefers response-level metadata
          "openai/outputTemplate": UI_RESOURCE_URI,
          "openai/widgetAccessible": true,
          "openai/resultCanProduceWidget": true,
        },
