...
This repository contains one active starter app for minimal ChatKit integration:

- [**Managed ChatKit**](managed-chatkit) – managed ChatKit integration with hosted workflows.
